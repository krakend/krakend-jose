...
func Example_RS256() {
	...
	//  DEBUG: [[ENDPOINT: /private][JWTValidator] Roles matcher assigned: regular]
	//  DEBUG: [[ENDPOINT: /private][JWTValidator] Required scopes: [], scopes key: '']
	//  DEBUG: [[ENDPOINT: /private][JWTValidator] Scopes matcher assigned: default]
	...
	//  DEBUG: [[ENDPOINT: /refresh_token][JWTValidator] Roles matcher assigned: regular]
	//  DEBUG: [[ENDPOINT: /refresh_token][JWTValidator] Required scopes: [], scopes key: '']
	//  DEBUG: [[ENDPOINT: /refresh_token][JWTValidator] Scopes matcher assigned: default]
